...
<span {{ $attributes->class(['ui-icon'])->merge(['style' => "display:inline-flex;align-items:center;justify-content:center;vertical-align:middle;line-height:1;flex-shrink:0;width: {$size}px; height: {$size}px;"]) }}>
    @switch($icon)
        ...
        @case('theme')
            ...
            @break
        @case('flag')
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 21V4"></path><path d="M5 5c4-3 7 3 14 0v9c-7 3-10-3-14 0"></path></svg>
            @break
        @case('chevron-down')
